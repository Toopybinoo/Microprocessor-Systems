...
PTH_E_INT EQU $A0 ; If SENSOR_LINE < PTH_E_INT robot must shift right
PTH_F_INT EQU $A4 ; If SENSOR_LINE > PTH_F_INT robot must shift left


INC_DIS EQU 600     ; INCREMENT distance
FWD_DIS EQU 800    ; FORWARD distance
...
NO_FWD_BUMP 
  BRSET PORTAD0,$08,NO_REV_BUMP ; Else if REV_BUMP, then 
...
NO_REV_BUMP LDAA D_DETN ; Else if D_DETN equals 1 then
  BEQ NO_LT_INTXN ; The robot should make a RIGHT turn [THIS CHANGE CAUSED GLITCH]
